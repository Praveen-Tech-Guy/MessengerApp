...
import Vercellogo from "@/public/vercel-copy.svg"
                        ...
                        <div className="mx-auto max-w-7xl px-6">
                            <div className="text-center sm:mx-auto lg:mr-auto lg:mt-0">
                                ...
                                <TextEffect
                                    ...
                                    TailFlow organises conversations into channels with threads,
                                    is realtime and uses AI to keep teams sync.
                                </TextEffect>
                ...
                <section className="bg-background pb-16 pt-16 md:pb-32">
                    <div className="group relative m-auto max-w-5xl px-6">
                        ...
                        <div className="group-hover:blur-xs mx-auto mt-12 grid max-w-2xl grid-cols-4 gap-x-12 gap-y-8 transition-all duration-500 group-hover:opacity-50 sm:gap-x-16 sm:gap-y-14">
                            ...
                            <div className="flex">
                                <Image
                                    className="mx-auto h-4 dark:invert"
                                    src={Kindelogo}
                                    alt="Column Logo"
                                />
                            </div>
                            ...
                            <div className="flex">
                                <Image
                                    className="mx-auto h-5 dark:invert-0"
                                    src={Neonlogo}
                                    alt="Nike Logo"
                                />
                            </div>
